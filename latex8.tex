...
submitting your manuscript to the IEEE Computer Society Press. Note
there have been some changes to the measurements from previous
instructions.
...
Where appropriate, include the name(s) of editors of referenced
books.
