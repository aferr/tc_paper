...
The {\em inter-program} timing channels happen when one program's timing depends
...
the victim's key.
%In the previous architecture study \cite{FIXME}, such inter-program interference is named
