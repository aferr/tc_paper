...
% handled separately, the process can be run in privileged mode even though it is 
% run in a TC with user-space processes or unprivileged VMs. However, care must 
% be taken if the IO operation depends on secrets of both the OS and the 
% requesting TC.
